...
public class GetCognosLocalesServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String[] cognosLocales = StringUtils.split((String) request.getSession().getAttribute("cognosLocales"), ",");
			result.put("status", "OK");
			result.put("content", (String) request.getSession().getAttribute("cognosLocales"));
